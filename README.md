[![Test](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/actions/workflows/test.yml/badge.svg)](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/actions/workflows/test.yml)
[![Deploy](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/actions/workflows/deploy.yml/badge.svg)](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/actions/workflows/deploy.yml)

## Supported tags and respective `Dockerfile` links

* [`python3.9`, `latest` _(Dockerfile)_](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/blob/master/docker-images/python3.9.dockerfile)
* [`python3.9-alpine3.13` _(Dockerfile)_](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/blob/master/docker-images/python3.9-alpine3.13.dockerfile)
* [`python3.8-alpine3.11` _(Dockerfile)_](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/blob/master/docker-images/python3.8-alpine3.11.dockerfile)
* [`python3.7`, _(Dockerfile)_](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/blob/master/docker-images/python3.7.dockerfile)
* [`python3.7-alpine3.8` _(Dockerfile)_](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/blob/master/docker-images/python3.7-alpine3.8.dockerfile)
* [`python3.6` _(Dockerfile)_](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/blob/master/docker-images/python3.6.dockerfile)
* [`python3.6-alpine3.8` _(Dockerfile)_](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker/blob/master/docker-images/python3.6-alpine3.8.dockerfile)
...
[**GitHub repo**](https://github.com/DNK-IT-Solutions/meinheld-gunicorn-docker)

[**Docker Hub image**](https://hub.docker.com/r/dnkitsolutions/meinheld-gunicorn/)
